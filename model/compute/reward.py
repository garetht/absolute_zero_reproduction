...
"""
def compute_r_solve(answers: Answers) -> Float[Tensor, "task batch_size"]:
    pass
...
"""
def compute_r_propose(r_solve: Float[Tensor, "task batch_size"]) -> Float[Tensor, "task"]:
    pass

"""
Computes the total reward for the model's answer, validating the format and correctness of the answer.
"""
def compute_r_total(answers: Answers) -> Float[Tensor, "task"]:
    pass
